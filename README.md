...
| **Cloud when you want** | Any OpenAI-compatible API, Claude Code or OpenCode — opt-in, off by default |
...
checksummed release assets — no manual provisioning.
...
Slate is **open-core**. This repository — the app — is fully open source (MIT).
It builds and runs completely on its own; a small paid layer (**SlatePro**:
